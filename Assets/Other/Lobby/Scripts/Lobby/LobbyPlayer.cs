...
namespace Prototype.NetworkLobby
{
    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        ...
        public static Color[] Colors = new Color[] { Color.red, Color.green, Color.yellow, Color.blue }; 
        ...
        public void ColorsChange(int a)
        {
            print(a);
            if (a == 4)
            {
        ...
        public void CheckRemoveButton()
        {
            ...
            //playercount -= 1;
            //if (playercount<3)
           //     Colors = new Color[] { Color.red, Color.green, Color.red, Color.green };
